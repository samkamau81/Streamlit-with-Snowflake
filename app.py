...
st.write(
    "A simple machine laerning app to predict the the mental state of people and give advice on the way forward"
)

st.subheader("Questionnaire")
st.write("Answer these few questions to help me understand your situation more")
